...
window.onload = function() {
    ...
    //setInterval(placeCactus, timeObstacle); //1000 milliseconds = 1 second
    document.addEventListener("keydown", moveDino);
}

function frecuenciaAparicionObjetos() {
    setTimeout(() => {
        placeCactus(); // Llama a la función
...
function placeCactus() {
    ...
    else if (placeCactusChance > .65) { //30% you get cactus2
        cactus.img = cactus2Img;
        cactus.width = cactus2Width;
        cactusArray.push(cactus);
    }
    else if (placeCactusChance > .35) { //25% you get cactus1
